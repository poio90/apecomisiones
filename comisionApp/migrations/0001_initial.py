# Generated by Django 2.2.6 on 2019-12-05 15:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='comision',
            name='num_afiliado',
            field=models.ForeignKey(db_column='num_afiliado', null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='ciudad',
            name='id_provincia',
        ...
        migrations.CreateModel(
            name='Agente',
            fields=[
                ('num_afiliado', models.CharField(max_length=45, primary_key=True, serialize=False, unique=True, verbose_name='Número de Afiliado')),
